...
<div class="card overflow-hidden">
    <div class="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 bg-slate-50/60 px-5 py-4">
        ...
        <select id="filter_kelas" class="input !w-auto cursor-pointer">
        ...
        <form method="GET" action="{{ route('absensi.export') }}" class="flex flex-wrap items-center gap-2">
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-wider text-slate-500">Tanggal</th>
                        <th class="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-wider text-slate-500">Siswa</th>
                        <th class="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-wider text-slate-500">Kelas</th>
                        <th class="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-wider text-slate-500">Keterangan</th>
                    </tr>
                </thead>
